<div id="ImportModal" class="hidden fixed inset-0 bg-gray-400 bg-opacity-60 justify-center items-center ">
    <div class="bg-gray-800 rounded-lg w-1/2">
        <form method="POST" action="/region-admin/import" enctype="multipart/form-data" class=" w-5/6 mx-auto my-5">
            @csrf
